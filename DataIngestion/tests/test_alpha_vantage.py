...
class TestAlphaVantage(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        alpha_vantage._client = httpx.AsyncClient()
    ...
    async def test_get_time_series_compact(self):
        ...
        # Act
        time_series = await alpha_vantage.get_time_series_compact(symbol)
    ...
    async def test_get_time_series_full(self):
        # Arrange
        symbol = 'TSLA'

        # Act
        time_series = await alpha_vantage.get_time_series_full(symbol)
